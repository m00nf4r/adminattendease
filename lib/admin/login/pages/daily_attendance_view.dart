...
class _DailyAttendancePageState extends State<DailyAttendancePage> {
  ...
  // 3. FILTERED DATA (The list actually shown on screen)
    ...
    setState(() {
      if (selectedDept == "All Departments") {
        ...
        filteredData = attendanceData
            .where((emp) => emp["dept"] == selectedDept)
            .toList();
      }
    });
  }
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  ElevatedButton(
                    onPressed: _handleSearch, // Search logic called here
              ...
              children: [
                ...
                Expanded(
                  child: filteredData.isEmpty
                      ? const Center(
                          child: Text("No records found for this department"),
                        )
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) =>
                              _buildDataRow(filteredData[index]),
                        ),
                ),
  ...
  Widget _buildFilterDropdown(String label, String value) {
    List<String> depts = ["All Departments", "IT", "HR"];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
